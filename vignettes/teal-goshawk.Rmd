...
### Sample Longitudinal Analysis App
Please see the [Sample Longitudinal Analyses App]() for a full demonstration of how `teal.goshawk` can be deployed as a stand alone app that includes the following tabs:
...
Refer to the [Get Started](https://insightsengineering.github.io/teal.modules.clinical/get-started) section of the
teal.modules.clinical package that provides additional detail on `teal` concepts as applied in another simple app
example.
