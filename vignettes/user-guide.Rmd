...
### AVISIT
The "Analysis Visit" (AVISIT) variable is used to display visit as an abbreviated analysis visit value (AVISITCD). See the [Data Expectations]() article for more detail on the AVISITCD variable.
